    ...
    <div>
      ...
      >
        <div className="relative h-14 w-14 rounded-full">
          ...
          <span className="absolute right-0 bottom-0 h-3.5 w-3.5 rounded-full border-2 border-white bg-meta-3" />
        </div>
      ...
      >
        <div className="relative h-14 w-14 rounded-full">
          ...
          <span className="absolute right-0 bottom-0 h-3.5 w-3.5 rounded-full border-2 border-white bg-meta-6" />
        </div>
      ...
      >
        <div className="relative h-14 w-14 rounded-full">
          ...
          <span className="absolute right-0 bottom-0 h-3.5 w-3.5 rounded-full border-2 border-white bg-meta-7" />
        </div>
